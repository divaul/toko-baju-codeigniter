...
class Pages extends CI_Controller {
	...
	public function event()
    {
        ...
        get_header(get_store_name());
        get_template_part('pages/event', $data);
        get_footer();
    }
	...
	public function produk()
    {
        ...
        get_header(get_store_name());
        get_template_part('pages/produk', $data);
        get_footer();
    }
	...
	public function review()
    {
        ...
        get_header(get_store_name());
        get_template_part('pages/review', $data);
        get_footer();
    }
		...
		public function koleksi()
    {
        ...
        get_header(get_store_name());
        get_template_part('pages/koleksi', $data);
        get_footer();
    }
			...
			public function Galeri()
    {
        ...
        get_header(get_store_name());
        get_template_part('pages/Galeri', $data);
        get_footer();
    }
			...
			public function Inspirasi()
    {
        ...
        get_header(get_store_name());
        get_template_part('pages/Inspirasi', $data);
        get_footer();
    }

			public function ReferensiGaya()
    {
        $profile = user_data();
        ...
        get_header(get_store_name());
        get_template_part('pages/ReferensiGaya', $data);
        get_footer();
    }
